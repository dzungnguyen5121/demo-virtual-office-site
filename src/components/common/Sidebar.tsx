...
const mainNavItems = [
  ...
  { to: "/dashboard/calls", label: "Manage Calls", icon: <Phone className="h-4 w-4" /> },
  { to: "/dashboard/docs", label: "Manage Documents", icon: <Files className="h-4 w-4" /> },
      ...
      <nav className="px-2">
        {mainNavItems.map((it) => (
            <NavLink
              ...
              className={({ isActive }) =>
                `flex w-full items-center gap-3 rounded-xl px-3 py-2 text-left text-sm font-medium hover:bg-slate-50 ${
